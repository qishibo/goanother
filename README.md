...
Download latest package from [github](https://github.com/qishibo/AnotherRedisDesktopManager/releases) or [gitee](https://gitee.com/qishibo/AnotherRedisDesktopManager/releases).

If you are Mac user, you can also:
- By **brew**: `brew install --cask another-redis-desktop-manager`
- Or **sponsor** by app store, It's not free, thank you very much for your sponsorship.
